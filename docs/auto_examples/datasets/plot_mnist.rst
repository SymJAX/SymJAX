.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_datasets_plot_mnist.py>`     to download the full example code
    .. rst-class:: sphx-glr-example-title

    .. _sphx_glr_auto_examples_datasets_plot_mnist.py:
...
.. image:: /auto_examples/datasets/images/sphx_glr_plot_mnist_001.svg
...
.. _sphx_glr_download_auto_examples_datasets_plot_mnist.py:
